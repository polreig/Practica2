...
grafico3<-ggplot(data=ds, aes(x=MinTemp,y=MaxTemp,color=RainTomorrow))+geom_point()+ggtitle("Relación entre Temperatura Mínima y Máxima por Condición de Lluvia")
  
print(grafico1)
print(grafico2)
print(grafico3)

ggsave("Ejercicio1.pdf",plot=grafico3)
```
